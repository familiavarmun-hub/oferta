    ...
    switch ($action) {
        ...
        case 'get_negotiation_history':
            ...
            foreach ($history as &$item) {
                $item['avatar'] = '../mostrar_imagen.php?id=' . (int)$item['user_id'];
            }
        ...
        case 'get_my_product_offers':
            ...
            foreach ($offers as &$offer) {
                $offer['seller_avatar'] = '../mostrar_imagen.php?id=' . (int)$offer['seller_id'];
            }
        ...
        case 'get_seller_product_offers':
            ...
            foreach ($offers as &$offer) {
                $offer['buyer_avatar'] = '../mostrar_imagen.php?id=' . (int)$offer['buyer_id'];
            }
        ...
        case 'get_product_negotiation_history':
            ...
            // Procesar avatares
            foreach ($history as &$item) {
                $item['user_avatar'] = '../mostrar_imagen.php?id=' . (int)$item['user_id'];
            }
