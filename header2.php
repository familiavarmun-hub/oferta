...
// Si el usuario está logueado, usamos la función para mostrar la imagen con laurel e insignia
if (isset($_SESSION['usuario_id'])) {
...
<nav class="mobile-bottom-nav">
    <ul>
        ...
        <!-- NUEVO: Botón de Chat en barra inferior móvil -->
        <li>
